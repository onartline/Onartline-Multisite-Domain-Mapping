...
class omdm_Domain_Mapper {
    ...
    public function map_domain(): void {
        ...
        // wp-login.php ausnehmen, damit POST-Daten (z. B. beim Login) durch
        // eine 301-Weiterleitung nicht verloren gehen.
     ...
     */
    public function get_primary_domain( int $blog_id ): ?object {
     ...
     * Wird von class-omdm-network-admin.php nach save/delete aufgerufen.
     */
